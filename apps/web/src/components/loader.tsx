    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative flex h-12 w-12 items-center justify-center rounded-lg bg-lime-cs shadow-glow">
          <span className="font-mono font-bold text-base leading-none select-none" style={{ color: "var(--logo-text)" }}>
            &gt;
            <span className="[animation:cursor-blink_1s_step-start_infinite]" aria-hidden="true">
              _
            </span>
          </span>
        </div>
